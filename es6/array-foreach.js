...
// 自己做一個Polyfill，擴增Array物件的方法
Array.prototype.forEach = function(callback, thisArg) {
  // 如果給的引數不是function要彈error
...
// 自己做一個helper function，供callback使用
...
// forEach()用陣列當作this，並且用for去遍歷執行另一個callback: logArrayElements()
// forEach()會把logArrayElements()需要的引數傳進去
// 執行logArrayElements()

[2, 5, , 9].map((item, index) => {
