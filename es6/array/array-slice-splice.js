...
// [！！！重要！！！] splice() 方法更改原有的 array，slice() 则不动原 array
...
// [19] splice return回來的「不含」插入的元素！而是「被移除的」元素
...
// [重要！] 如果第二个参数小于 0，或者是 NaN，则会被当做 0 对待
var array6 = [26, 27, 28, 29, 30];
console.log(array6.splice(2, -15, "Hello"));
// []
...
console.log(array7.splice(23, 3, "Add Me")); // 第二個參數這邊是多少就無意義，因為已經在最後面了
// []
...
// slice() 切片方法 可以接收两个参数：
// arr.slice([begin[, end]])
// [！！重要！！] 获取的结果包含了 begin 位置的值，但不包含 end 位置的值，即 [begin, end)
