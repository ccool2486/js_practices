...
var me = {
  ...
  lastName: "Doe",
  fullName: function() {
    logFullNameWithContext.call(this); //因為要用的函式不在這個物件內，可以透過call/apply來讓這個元件使用該函式
  }
};
...
var nums = [1, 2, 3, 4, 5]
console.log(sumAll(nums)) //15

// [!!重要!！]我们可以暴露一个方法，让用户自己选择回调函数的上下文
